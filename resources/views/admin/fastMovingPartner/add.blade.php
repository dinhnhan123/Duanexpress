    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold">
                Thêm ảnh đối tác cty 2express
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('fastMovingPartner.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="image_id_fastMoving" name="image_id_fastMoving">
                        <div id="uploadFile">
                            <input type="file" name="file-image-fastMoving" id="file-image-fastMoving" data-url="{{ route('uploadImageFastMovingPartner') }}"> 
                            <input type="submit" name="Upload" value="Upload" id="Upload-image-fastMoving">
