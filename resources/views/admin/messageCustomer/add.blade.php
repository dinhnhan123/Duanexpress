    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold">
                Thêm ảnh tin nhắn khách hàng
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('messageCustomer.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="image_id_messageCusomer" name="image_id_messageCusomer">
                        <div id="uploadFile">
                            <input type="file" name="file-image-messageCutomer" id="file-image-messageCutomer" data-url="{{ route('uploadImageMessageCustomer') }}"> 
                            <input type="submit" name="Upload" value="Upload" id="Upload-image-messageCutomer">
