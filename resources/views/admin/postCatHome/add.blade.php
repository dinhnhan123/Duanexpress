        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.PostCatHome.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="category_content" class="form-control" id="category_content" cols="30" rows="10">{{old('category_content')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div id="uploadFile">
                                    <input type="file" name="file-image-postCatHome" id="file-image-postCatHome" data-url="{{ route('uploadImagePostCatHome') }}"> 
                                    <input type="submit" name="Upload" value="Upload" id="Upload-image-postCatHome">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="category_status" name="category_status">
                                    ...
                                    <option value="pending" {{old('category_status') == 'pending'?'selected':''}}>Chờ duyệt</option>
                                </select>
