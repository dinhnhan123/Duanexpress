            ...
            <div class="card-body">
                <form method="POST" action="{{ route('slider.update',$slider->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="image_id_slider" name="image_id_slider">
                        <div id="uploadFile">
                            <input type="file" name="file-image-slider" id="file-image-slider" data-url="{{ route('updateImageSlider') }}"> 
                            <input type="submit" name="Upload" value="Upload" id="update-Upload-image-slider">
                            <div id="show_image_slider">
                                <img src="{{asset($slider->image->image_url)}}" alt="" id="image-slider" data-id-slider="{{$slider->id}}" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
