            ...
            <table class="table table-striped table-checkall">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>{{$temp}}</td>
                        <td class="wp-image-slider"><img src="{{ asset($slider->image->image_url) }}" alt="" id="image-slider"></td>
                        ...
                        <td>
                           ...
                           @if ($status == "trash")
                           <a href="{{ route('slider.delete',$slider->id) }}?status={{$status}}" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="if(!confirm('Bạn có muốn xóa vĩnh viễn không?')) {event.preventDefault();}"><i class="fa fa-trash"></i></a>
                           @else
                           <a href="{{ route('slider.delete',$slider->id) }}" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="if(!confirm('Bạn có muốn xóa tạm thời không?')) {event.preventDefault();}"><i class="fa fa-trash"></i></a>
                           @endif
