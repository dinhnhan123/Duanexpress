    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold">
                Chỉnh sửa ảnh cty 2vexpress
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('Image2vexpress.update',$slider->id) }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="image_id_imageV2express" name="image_id_imageV2express" hidden>
                        <div id="uploadFile">
                            <input type="file" name="file-image-v2express" id="file-image-v2express" data-url="{{ route('updateImage2vexpress') }}"> 
                            <input type="submit" name="Upload" value="Upload" id="update-Upload-image-v2express">
                            <div id="show_image_v2express">
                                <img src="{{asset($slider->image->image_url)}}" alt="" id="image-imageV2express" data-id-slider="{{$slider->id}}" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
